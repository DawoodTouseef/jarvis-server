...
from backend.internal.wrappers import register_connection
...
def handle_peewee_migration(DATABASE_URL):
    ...
    try:
        ...
        migrate_dir = BACKEND_DIR / "internal" / "migrations"
...
if SQLALCHEMY_DATABASE_URL.startswith("sqlite+sqlcipher://"):
    ...
    def create_sqlcipher_connection():
        try:
            ...
            raise ImportError("sqlcipher3 is required for encrypted SQLite databases")
