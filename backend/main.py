...
from backend.utils.audit import AuditLevel, AuditLoggingMiddleware
from backend.utils.logger import start_logger
from backend.socket.main import (
    app as socket_app,
...
from backend.models.users import UserModel, Users
...
from backend.utils.embeddings import generate_embeddings
from backend.utils.middleware import process_chat_payload, process_chat_response
from backend.utils.access_control import has_access
...
from backend.utils.plugin import install_tool_and_function_dependencies
...
from backend.utils.redis import get_sentinels_from_env
...
https://github.com/DawoodTouseef/jarvis-server
"""
)
...
if ENABLE_OTEL:
    from backend.utils.telemetry.setup import setup as setup_opentelemetry
        ...
        if request.method == "GET":
            ...
            if "shared" in query_params and len(query_params["shared"]) > 0:
                ...
                if text:
                    ...
                    if urls:
                        from backend.retrieval.loaders.youtube import _parse_video_id
